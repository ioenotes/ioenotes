...
description: "Detailed syllabus for Computer Programming (CT101), a first year, first part subject in the IOE BCT (Bachelor of Computer Engineering) program. Covers C programming fundamentals, data structures, and programming concepts."
draft: false
...
For updates specific to this Computer Programming (CT101) syllabus page, you can [suggest an edit directly on GitHub](https://github.com/ioenotes/ioenotes/blob/main/content/english/syllabus/computer/year1-part1/computer-programming-ct-101.md). Your help is invaluable in keeping this resource beneficial for all students! 